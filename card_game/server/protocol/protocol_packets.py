...
from ..models.server_models import ClientSession
...
def extract_client_slot_hint(body: JsonObject, normalize_slot=normalize_client_slot) -> str | None:
...
def build_packet_blueprint(packet_type: str, body: JsonObject, is_response: bool) -> JsonObject:
    return {
        'IsResponse': bool(is_response),
        'PacketType': packet_type,
        'Body': body,
